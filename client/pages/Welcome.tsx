  ...
  return (
    <div id="top" className="min-h-screen bg-[#f7f5f2] text-gray-900">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-gray-600 md:flex">
            ...
            <Button
              ...
              className="rounded-full bg-gray-900 px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-gray-800"
            >
              Get Quote
            </Button>
          </nav>
      ...
      <main>
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1.2fr] lg:min-h-[600px] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                onClick={() => navigate("/user-login")}
                className="rounded-full bg-gray-900 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-gray-800"
              >
                Explore Projects
              </Button>
              <Button
                ...
                variant="outline"
                className="rounded-full border-gray-300 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em]"
              >
                Meet the Team
              </Button>
            </div>
        ...
        <section className="mx-auto -mt-10 max-w-6xl px-4 pb-6 sm:px-6">
          <div className="grid gap-4 rounded-[28px] bg-white p-6 shadow-xl lg:grid-cols-[2fr_1fr_1fr_1fr_auto]">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-gray-200 px-4 py-3">
              ...
              <select className="w-full text-sm text-gray-700 outline-none">
                <option>Location</option>
                <option>Downtown LA</option>
                <option>West LA</option>
                <option>South LA</option>
              </select>
            </div>
            <div className="flex items-center gap-3 rounded-2xl border border-gray-200 px-4 py-3">
            ...
            <Button className="rounded-2xl bg-amber-500 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-amber-400">
              Search
            </Button>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-6 sm:px-6">
          <div className="sticky top-[76px] z-40 flex flex-wrap items-center gap-3 rounded-full border border-black/5 bg-white/90 px-4 py-3 shadow-sm">
            {filters.map((filter) => (
              <button
                key={filter}
        ...
        <section id="projects" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <div className="flex items-end justify-between gap-6 pb-8">
            ...
            <Button
              variant="outline"
              className="hidden rounded-full border-gray-300 text-xs font-semibold uppercase tracking-[0.2em] md:flex"
            >
              View All
            </Button>
          </div>
        ...
        <section id="services" className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="space-y-4">
              ...
              <Button
                variant="outline"
                className="rounded-full border-gray-300 text-xs font-semibold uppercase tracking-[0.2em]"
              >
                Our Services
              </Button>
            </div>
        ...
        <section id="about" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <div className="rounded-[32px] border border-black/5 bg-white p-10 shadow-sm">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Button className="rounded-full bg-gray-900 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-gray-800">
                Meet the Team
              </Button>
            </div>
            <div className="mt-8 grid gap-6 sm:grid-cols-3">
              {[
                { name: "Rahul Mehra", role: "Lead Project Manager" },
                { name: "Anjali Desai", role: "Senior Site Engineer" },
                { name: "Vikram Joshi", role: "Construction Director" },
              ].map((member) => (
      ...
      <footer id="contact" className="border-t border-black/5 bg-white">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1.2fr_1fr]">
          <div className="space-y-4">
            ...
            <Button
              onClick={() => navigate("/user-login")}
              className="rounded-full bg-amber-500 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-amber-400"
            >
              Request a Quote
            </Button>
          </div>
